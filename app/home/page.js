  ...
  return (
    <div className=" bg-white pt-7">
      ...
      <div className='flex justify-center items-center font-bold w-full'>
        <div className='flex justify-center items-center mx-nine mx-ten lg:w-4/6 xl:w-3/5 gap-3'>
          <p className='w-2/5 lg:w-2/5 xl:w-2/6 max-sm:text-right md:text-center  text-lg sm:text-xl md:text-5xl lg:text-4xl xl:text-6xl'>Tomorrow's</p>
          <div className='w-4/5 lg:w-3/5 xl:w-4/6'>
            <div className="relative h-7 md:h-14 xl:h-18 flex w-full items-center justify-center overflow-hidden border-[0.5px] rounded-full text-[19px] sm:text-2xl md:text-[52px] lg:text-[40px] xl:text-[67px] inset-0 ">
